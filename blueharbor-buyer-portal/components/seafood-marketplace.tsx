    ...
    <>
      ...
      {!signedIn && (
        <section className="demo-invitation">
          <ShieldCheck size={28} />
          <div>
            <h3>Your seafood trading workspace.</h3>
            <p>
              Sign in to browse available stock. Create an account and complete
              admin verification before placing your first order.
            </p>
          </div>
