      ...
      <main className="workspace-main">
        <header className="topbar">
          ...
          <div className="header-actions">
            <a href="https://www.vtabsquare.com/?demo=1&product=blueharbor-fish-exchange&source=blueharbor-buyer-portal" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.3rem', padding: '0.5rem 0.75rem', borderRadius: '0.6rem', background: '#155e75', color: '#fff', fontWeight: 700, textDecoration: 'none', fontSize: '0.8rem' }}>Contact for Demo <ArrowUpRight size={15} /></a>
